...
public class GradleStart extends GradleStartCommon {
    ...
    protected String getBounceClass() {
        return System.getProperty("gradlestart.bouncerClient", "net.minecraft.launchwrapper.Launch");
    }

    @Override
    protected String getTweakClass() {
        return System.getProperty("gradlestart.clientTweaker", "cpw.mods.fml.common.launcher.FMLTweaker");
    }
